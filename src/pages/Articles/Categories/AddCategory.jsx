...
const AddCategory = () => {
  ...
  const { name, setName, handleSubmit, catlist, setCatlist } = Categories()
  // gett caat list
  useEffect(() => {
    ...
    <div initial='hidden' animate='visible' className='grid grid-cols-12'>
      ...
      <div className='col-span-9 max-h-36  bg-background2-light dark:bg-background2-dark rounded-xl p-5 mr-4'>
        <div className='relative  z-0 w-full mb-6 group'>
          ...
          <label
            for='Name'
            className={` text-gray-light font-medium mr-1 bg-background2-light peer-focus:font-medium absolute text-sm  dark:text-white  duration-300 transform -translate-y-6 top-3  origin-[0] peer-focus:text-gray-light  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0  peer-focus:-translate-y-6 peer-focus:z-[999] px-2 rounded-lg peer-placeholder-shown:-z-10 z-30 peer-placeholder-shown:text-black`}
          >
            {`نام دسته بندی جدید `}
          </label>
        </div>
